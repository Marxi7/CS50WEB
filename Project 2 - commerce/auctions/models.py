...
class Bids(models.Model):
    ...
    listing = models.ForeignKey(Listings, on_delete=models.CASCADE, null=True, blank=True, related_name="listing_bids")
...
class Comments(models.Model):
    ...
    listing = models.ForeignKey(Listings, on_delete=models.CASCADE, null=True, blank=True, related_name="listing_comment")
    date = models.DateTimeField(auto_now_add=True)
